        ...
        <div class="col-md-12">
          ...
          <br>
           ...
           <?php
		       ...
		       $sql=mysql_query("SELECT * FROM des_liquidar_contratos where estadoLiquida like 'Pagado' order by idenCliente ASC");
		   
		   ?>
          <div class="table-responsive">
              <h3>Listado Planes Liquidados</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  while($row = mysql_fetch_array($sql)){
                    ...
                    $sqlC=mysql_query("SELECT * FROM des_contratos_empresas where id like '$idContrato'");
                    while($rowCon = mysql_fetch_array($sqlC)){
                      $idPlan=$rowCon ['idPlan'];
                      $municipio=$rowCon ['municipio'];
                      $nombreCiudad="";
