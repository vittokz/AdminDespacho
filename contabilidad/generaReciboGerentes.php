...
table#mitabla td {
   ...
   <?php
     ...
     while($rowL = mysql_fetch_array($sqlL)){
         ...
         $gerenteComercial=$rowL['gerenteComercial'];
         $gerenteGeneral=$rowL['gerenteGeneral'];
     }
    ...
    $sqlEmpleado="SELECT empresa,dir_cliente FROM des_cliente WHERE cedula_cliente like '$identidad'";
    ...
    <table id="mitabla" align="center">
          ...
          <table id="mitabla" border="0" align="center">
               ...
               <tr>
                 ...
                 <td><?php echo "$ ".number_format(round(($gerenteGeneral)));?></td>
               </tr>
            ...
            <table id="mitabla" align="center">
                ...
                <tr> 
                  ...
                  <td colspan="2">Pago comisión Gerente Comercial</td>
                  </tr>
                <tr>
                  <td><span style="color:BLUE">Nombre Empresa</span><br>
                  <?php echo strtoupper($nombreEmpresa);?>
          ...
          <table id="mitabla" border="0" align="center">
               ...
               <tr>
                 <td style="background-color:#096075; color:#FFFFFF" align="right">TOTAL</td>
                 <td><?php echo "$ ".number_format(round(($gerenteComercial)));?></td>
               </tr>
