...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <title>.::Contratos Clientes::.</title>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Realizar Fáctura Planes</h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-6">
              ...
              <table class="table table-hover">
                <tr>
                  <th><select name="tipo" id="tipo"class="form-control">
                      <option value="Identidad">Identificacion</option>
                      <option value="Empresa">Empresa</option>
                  </select>
                 </th>
                  <th><input type="text" class="form-control" id="buscar" required autofocus></th>
                </tr>
              </table>   
              <div class="box-footer">
                        <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="validarEmpresa(); return false;">Validar</button>
                    </div>
            </form>
            <br>
             <div id="resultado">
          ...
          <!-- general form elements -->
          <div class="box box-primary">
          <h3>Realizar Fáctura Otros Servicios</h3><br>
            <form name="empresasOtros">
              <table class="table table-hover">
                <tr>
                  <th><select name="tipo" id="tipo"class="form-control">
                      <option value="Identidad">Identificacion</option>
              ...
              <div class="box-footer">
                        <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="validarEmpresaOtros(); return false;">Validar</button>
                    </div>
            </form>
            <br>
             <div id="resultadoOtros">
       ...
       <!--   <div class="box box-primary">
            ...
            <form name="empresas">
              <table class="table table-hover">
                <tr>
                  <th><a href="../contabilidad2/ingresos.php">Ir Ingresos</a>
                 </th>
