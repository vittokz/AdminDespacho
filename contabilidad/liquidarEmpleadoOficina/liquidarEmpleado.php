...
<head>
  ...
  <title>.::Liquidar Empleado Oficina::.</title>
        ...
        <div class="col-md-12">
          ...
          <br>
           ...
           <?php
		       ...
		       $sql=mysql_query("SELECT * FROM des_contratos_empresas where usuarioRegistro like '$usuarioEmpleado' and activoFecha like 'Si'");
		   
		   ?>
          <div class="table-responsive">
              <h3>Listado Planes Vendidos y Activos</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  <?php
                     if($activoFecha=="Si"){
                  ?>
                  <a href="liquidarContratoEmpleado.php?identidad=<?php echo $identidad;?>&idPlan=<?php echo $idPlan;?>&fecha=<?php echo $fecha;?>&idContrato=<?php echo $idContrato;?>&empleado=<?php echo $usuarioRegistro;?>&nombre=<?php echo $nombre;?>"target="popup"
