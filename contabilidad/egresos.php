  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Verificar Identidad Empleado</h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <form name="empleado">
              ...
              <div class="box-footer">
                        <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="validarEmpleado(); return false;">Validar</button>
                    </div>
            </form>
            <br>
             <div id="resultado">
