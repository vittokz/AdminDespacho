          ...
          <div class="box box-primary">
             ...
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  <th>Fecha</th>
                  <th><input type="date" class="form-control" id="fecha"autofocus></th>
                  <th>Descripción</th>
              ...
              <div class="box-footer">
                <button title="Registrar gasto" style="background-color:#1d1a31" type="submit" class="btn btn-primary" onClick="enviarDatosGasto(); return false;">Registrar</button>
              </div>
             </div>
            </form>
            <br>
