...
<head>
  ...
  <title>.::Liquidar Asesor comercial::.</title>
...
<span style="font-size:26px; color:#FFF; font-weight:800; font-family:Georgia, 'Times New Roman', Times, serif">
VIGILANCIA DE ACTUACIONES PROCESALES
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Liquidar Asesor Comercial</h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <div class="box-body table-responsive no-padding">
             ...
             <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
                      <th>Fecha Inicial</th>
                      <th><input type="date" class="form-control" id="fecha1" required autofocus>
                         <input type="hidden" class="form-control" id="identidad" value="<?php echo $identidad;?>">
                         <input type="hidden" class="form-control" id="nombre" value="<?php echo $nombre;?>">
                    ...
                    <div class="box-footer">
                         <button title="Generar" type="submit" class="btn btn-primary" onClick="generarPago(); return false;">Generar</button>
                    </div> 
                </div>
              </form>
            <br>
