<?php require_once("../seguridad/seguridad.php");
     ...
     $sql=mysql_query("SELECT * FROM des_contratos_empresas where identidad like '$identidad' and numComprobante like '$idContrato'");
...
<head>
  ...
  <title>.::Liquidar Contratos::.</title>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1> Información Cliente - Liquidar </h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
               ...
               <tr>
                  ...
                  <th>Descuento</th>
                  <th style="color:#069"><?php echo $descuento." %";?></th>
               </tr>
               <tr>
                  <th>Valor Plan</th>
          ...
          <div class="box box-primary">
            ...
            <table class="table table-hover">
              ...
              <?php
                ...
                // if($numContratos<=0){
                  $sqlLiq=mysql_query("SELECT * FROM des_liquidar_contratos where idContrato like '$idContrato' order by idLiquida desc limit 1");
                  $numContratos = mysql_num_rows($sqlLiq);
                   if($numContratos>0){

                  ?>
                     <tr style="background-color:#1d1a31; color:#ffffff">
                          <th>Fecha Inicial</th>
                          <th>Fecha Final</th>
                          <th>Generar</th>
                     </tr>
                ...
                ?>                  <form name="pagar" id="pagar">       
                                      <tr>
                                          ...
                                          <th>
                                              ...
                                              <input type="hidden" class="form-control" id="descuento" value="<?php echo $descuento;?>">
                                              <input type="hidden" class="form-control" id="usuarioRegistro" value="<?php echo $usuarioRegistro;?>">
                                          </th>
                                          
                                          <th><button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="liquidar(); return false;">Generar</button></th>
                                      </tr>
                                    </form>
                  <?php
                    }
                 ...
                 ?>
                                    ...
                                    <form name="pagar" id="pagar">       
                                      <tr>
                                          ...
                                          <th><button type="submit" class="btn btn-primary" style="background-color:#1d1a31" onClick="liquidar(); return false;">Generar</button></th>
                                      </tr>
                                    </form>
             ...
             <table class="table table-hover">
              ...
              <tr style="background-color:#1d1a31; color:#ffffff">
                    ...
                    <th>Dias Cobrados</th>
                    <th>Valor a pagar</th>
                    <th>Recibo Empresa</th>
                   <!-- <th>Otros</th>-->
              </tr>

              <?php
                 $sqlL="SELECT * FROM des_liquidar_contratos where idContrato like '$idContrato' and estadoLiquida like 'Pagado' order by fechaRegistro DESC";
                 
                 $resSqlL=mysql_query($sqlL);
                 while($rowL = mysql_fetch_array($resSqlL)){
                     $periodoInicial=$rowL['periodoInicial'];
                     $periodoFin=$rowL['periodoFin'];
               ...
               ?>
                      <tr>
                          ...
                          <th><?php echo $periodoInicial." a ".$fechaAux;?></th>
                          <th>
                            <?php 
                                //$dias	= 30;
                                $diasT =(strtotime($periodoInicial)-strtotime($fechaAux))/86400;
                                $diasT =abs($diasT); 
                                $dias =floor($diasT);
                                if($dias<29)
                                    echo $dias;
                          ...
                          <th><a href="generaReciboEmpresa.php?idLiquida=<?php echo $idLiquida;?>" style="background-color:#1d1a31" class="btn btn-primary">Imprimir</button></th>
                       <!--   <th><a href="generaReciboGerentes.php?idLiquida=<?php echo $idLiquida;?>" class="btn btn-primary"></button></th>-->
                      </tr>
                  <?php
                    }
                    mysql_free_result($resSqlL);
