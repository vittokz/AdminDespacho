  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        ...
        <img  src='../img/atras.png' width='38' height='35' title="Volver a lista de procesos"></a>Audiencias\Proceso </h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <form method="post" action="registroArchivo.php" enctype="multipart/form-data">
             <table class="table table-hover">
               <tr>
                  ...
                  <input name="archivoA" required type="file" class="form-control"></th>
               </tr>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="font-size:11px">
                  ...
                  <?php
    		  		 if($tipoA=="Audio"){
    		   	  ?>
                  <a href="subirArchivo.php?idProceso=<?php echo $idProceso;?>&idArchivo=<?php echo $id;?>" target="popup"
onClick="window.open(this.href, this.target, 'toolbar=0 , location=1 , status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=150pt,top=50pt,width=1100px,height=350px'); return false;">
                 <img  src='../img/ver.png' width='48' height='28' title="Escuchar audio">Ver</a>
                  <?php
					 }
					else{ 
				  ?> 
                  <a href="archivos/audiencia<?php echo $idProceso."/".$nombreArchivo;?>">
                  <img  src='../img/ver.png' width='48' height='28' title="Ir a video">Ver</a>
                 ...
                 <?php
    		  		 if($tipoUsuario==1){
    		   	  ?>
                  <a style="text-decoration:none" href="eliminarArchivo.php?idArchivo=<?php echo $row['id'];?>&identidad=<?php echo $identidad;?>&idProceso=<?php echo $idProceso;?>">
