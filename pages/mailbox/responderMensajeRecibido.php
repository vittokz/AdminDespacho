<?php require_once("../../seguridad/seguridad.php");
    ...
    $remiteGet = $_GET["remite"];
    $asuntoGet = $_GET["asunto"];
    $mensajeGet = $_GET["mensaje"];
...
<head>
  ...
  <title>.::Redactar-Correo Electronico::.</title>
...
<div class="wrapper"  >
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="mailbox.php" style="background-color:#1d1a31" class="btn btn-warning btn-block margin-bottom">Volver a Mensajes</a>
        ...
        <!-- /.col -->
        <div class="col-md-9">
        <form name="correos" method="post" action="registrarResponderCorreo.php" enctype="multipart/form-data"> 
          
              <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title">Responder Email Recibido</h3>
                  </div>
                 <!-- /.box-header -->
                 <div class="box-body">
                 <div class="form-group" style="background-color:#D7D7D7">
                     Mensaje : <?php echo $mensajeGet;?>
                     <input type="hidden" name="mensajeAnterior" value="<?php echo $mensajeGet;?>"> 
                    </div>
                    <div class="form-group">
                     Destinatario : <?php echo $remiteGet;?>
                     <input type="hidden" name="destinatario" value="<?php echo $remiteGet;?>">  
                    </div>
                    <div class="form-group">
                      <input type="text" name="asunto" class="form-control" value="<?php echo "rev ".$asuntoGet;?>" autofocus required>
                    </div>
                    <div class="form-group">
               ...
               <!-- /.box-body -->
                <div class="box-footer">
                  <div class="pull-right">
                    <button type="submit" style="background-color:#1d1a31" class="btn btn-warning"><i class="fa fa-envelope-o"></i>Responder</button>
                  </div>
