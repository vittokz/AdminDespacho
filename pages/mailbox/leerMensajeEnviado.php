<?php require_once("../../seguridad/seguridad.php");
    ...
    if($logo==""){
     ...
     $sql=mysql_query("SELECT * FROM des_email where idEmail like '$idEmail'");
                       while($row=mysql_fetch_array($sql)) 
                        {
                            $asunto= $row["asunto"];
                            $idEmail= $row["idEmail"];
                            $remitente= $row["remitente"];
                            $mensajeEmail= $row["descripcion"];
                            $destinatario= $row["destinatario"];
                            $archivoAdjunto= $row["archivoAdjunto"];
                            $estadoEmail= $row["estado"];
                            $fechaRegistroEmail = $row["fechaRegistro"];
                        }
                      
    $sql=mysql_query("UPDATE des_email set estado='Leido' where idEmail like '$idEmail'");
?>
...
<head>
  ...
  <title>.::Leer Mensaje Enviado -Correo Electronico::.</title>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5>Para: <?php echo $destinatario;?>
                  <span class="mailbox-read-time pull-right"> <?php echo $fechaRegistroEmail;?></span></h5>
              </div>
              <!-- /.mailbox-read-info -->
              <div class="mailbox-controls with-border text-center">
                <div class="btn-group">
                  <button type="button" title="Eliminar mensaje" class="btn btn-default btn-sm" data-toggle="tooltip" data-container="body" title="Delete">
                    <i class="fa fa-trash-o"></i></button>
                 </div>
                <!-- /.btn-group -->
                <button type="button" title="Imprimir" class="btn btn-default btn-sm" data-toggle="tooltip" title="Print">
            ...
            <div class="box-footer">
              <ul class="mailbox-attachments clearfix">
                ...
                <?php
                  if($archivoAdjunto != "Sin archivo"){
                ?>
                  <div class="mailbox-attachment-info">
                    <a target="_blank" href="ArchivosCorreos/<?php echo $remitente;?>/<?php echo $archivoAdjunto;?>" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i>  <?php echo $archivoAdjunto;?></a>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <a href="registrarCorreo.php?asunto=<?php echo $asunto;?>&mensaje=<?php echo $mensajeEmail;?>&destinatario=<?php echo $destinatario;?>" type="button" class="btn btn-default"><i class="fa fa-reply"></i> 
                Reenviar</a>
                <a href="registrarCorreo.php?asunto=<?php echo $asunto;?>&mensaje=<?php echo $mensajeEmail;?>&destinatario=<?php echo $destinatario;?>" type="button" class="btn btn-default"><i class="fa fa-reply"></i> 
                Responder</a>
              </div>
              <a href="eliminarMensaje.php?idEmail=<?php echo $idEmail;?>" type="button" class="btn btn-default"><i class="fa fa-trash-o"></i> Eliminar</a>
             </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
