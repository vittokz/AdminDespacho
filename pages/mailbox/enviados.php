...
<head>
  ...
  <title>.::Correo Electronico Enviado::.</title>
...
<div class="wrapper"  >
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="mailbox.php" style="background-color:#1d1a31" class="btn btn-warning btn-block margin-bottom">Volver a Bandeja de Entrada</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li ><a href="mailbox.php"><i class="fa fa-inbox"></i> Bande de Entrada
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" title="Eliminar" class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></button>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                  <?php
                     $sql=mysql_query("SELECT * FROM des_email where remitente like 'asesoria@viacpro.com' order by fechaRegistro DESC");
                      $contMensajes=0; 
                     while($row=mysql_fetch_array($sql)) {
