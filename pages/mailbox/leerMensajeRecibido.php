...
<head>
  ...
  <title>.::Leer Mensaje -Correo Electronico::.</title>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
              ...
              <ul class="mailbox-attachments clearfix">
                ...
                ?>
                  <div class="mailbox-attachment-info">
                    <a target="_blank" href="../../../AdminClientes/pages/mailbox/ArchivosCorreos/<?php echo $remitente;?>/<?php echo $archivoAdjunto;?>" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i>  <?php echo $archivoAdjunto;?></a>
            ...
            <div class="box-footer">
              <div class="pull-right">
                <a href="registrarCorreo.php?asunto=<?php echo $asunto;?>&mensaje=<?php echo $mensajeEmail;?>" type="button" class="btn btn-default"><i class="fa fa-reply"></i> 
                Reenviar</a>
                <a href="responderMensajeRecibido.php?remite=<?php echo $remitente;?>&asunto=<?php echo $asunto;?>&mensaje=<?php echo $mensajeEmail;?>" type="button" class="btn btn-default"><i class="fa fa-share"></i> 
                Responder</a>
              </div>
