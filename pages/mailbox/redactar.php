              ...
              <div class="box box-primary">
                    ...
                    <div class="form-group">
                     Destinatario
                      <select name="destinatario" class="form-control">
                          <?php
                             $sql=mysql_query("SELECT * FROM des_cliente where estado like 'Activo'  order by empresa DESC ");
                              while($row = mysql_fetch_array($sql)){
                                  $empresa=$row['empresa'];
               ...
               <!-- /.box-body -->
                <div class="box-footer">
                  <div class="pull-right">
                    <button type="submit" style="background-color:#1d1a31" class="btn btn-warning"><i class="fa fa-envelope-o"></i> Enviar</button>
                  </div>
