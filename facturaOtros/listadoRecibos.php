        ...
        <div class="col-md-12">
         ...
         <div class="table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $idPlan="";
                $sql=mysql_query("SELECT * FROM des_liquidar_contratos where idenCliente like '$ccCliente'");
                ...
                while($row=mysql_fetch_array($sql)) {
                          ...
                          $sqlCliente=mysql_query("SELECT * FROM des_cliente WHERE cedula_cliente like '$ccCliente' and estado like 'Activo'");
              ...
              <tr style="font-size:11px; background:<?php echo $color;?>">
                  ...
                  <td><a target="_blank" href="generaReciboEmpresa.php?idLiquida=<?php echo $id;?>">Ver</a></td>                
