      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form name="cuentaCobro" method="post" action="generaCuentaCobro.php">
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  <th>Tipo</th>
                  <th><select id="tipo" name="tipo" class="form-control">
                      <option value="<?php echo $numRecibo;?>">Factura de Venta N° <?php echo $numRecibo;?> </option>
                   </select></th>
                  <th>Cliente</th>
                  <th colspan="3">
                  <input type="hidden" class="form-control" id="idCliente" name="idCliente" value="<?php echo $ccCliente;?>">
                ...
                <tr>
                  <th>Medio de Pago</th>
                  <th><select id="medio" name="medio" class="form-control" autofocus>
                     <?php   
                   ...
                   <th><input type="date" class="form-control" name="fechaEla" required></th>
                   <th>Fecha Vencimiento</th>
                   <th><input type="date" class="form-control" name="fechaVence" required></th>
              ...
              <div class="box-footer">
                <button title="Guardar" style="background-color:#1d1a31" type="submit" class="btn btn-primary">Guardar</button>
              </div>
