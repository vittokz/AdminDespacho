...
//enviar liquidar
function guardarCuentaCobroOtros(){
	...
	servicio=document.cuentaCobro.servicio.value;
	valorPago=document.cuentaCobro.valorPago.value;
		...
		ajax.send("tipoCuenta="+tipoCuenta+"&idCliente="+idCliente+"&empresa="+empresa+"&medio="+medio+"&fechaEla="+fechaEla+"&fechaVence="+fechaVence+"&servicio="+servicio+"&valorPago="+valorPago) 
