          ...
          <div class="box box-primary">
            ...
            <table class="table table-hover">
              ...
              <?php
                ...
                ?>                  <form name="pagar" id="pagar">       
                                      <tr>
                                          ...
                                          <th><button type="submit" class="btn btn-primary" onClick="liquidar(); return false;">OK</button></th>
                                      </tr>
                                    </form>
                  <?php
                    }
             ...
             <table class="table table-hover">
              ...
              <?php
                 $sqlL=mysql_query("SELECT * FROM des_liquidar_contratos where idContrato like '$idContrato' and estadoLiquida like 'Pagado' order by fechaRegistro DESC");
               ...
               ?>
                      <tr>
                          ...
                          <th><a href="generaReciboEmpresa.php?idLiquida=<?php echo $idLiquida;?>" class="btn btn-primary">Imprimir</button></th>
                      </tr>
                  <?php
                    }
                    mysql_free_result($sqlL);
