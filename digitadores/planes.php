...
<head>
  ...
  <title>.::Planes Dependientes::.</title>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
          <section class="content-header" style="width:100%">
            <h1>Planes asignados al Dependiente</h1><br>
              <div class="row">
                <div class="col-md-12">
                   ...
                   <div class="box-body">
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                          <?php
                              $sqlA=mysql_query("SELECT * FROM des_contratos_empresas where dependiente like '$idEmpleado' and estado like 'Activo'");
                              while($rowA = mysql_fetch_array($sqlA)){
                               
                                $idContrato=$rowA['id'];
                                $identidad=$rowA['identidad'];
                          ...
                          ?>
                            <tr style="font-size:12px">
                                  ...
                                  echo strtoupper($empresa." | ".$nombre);?></th>
                                  <th> 
                                  <?php    
                                   $sqlP=mysql_query("SELECT * FROM des_planes where idPlan like '$idPlan' and estado like 'Activo'");
                                      ...
                                      echo strtoupper($descripcion." ".$nomMuni );
                                   ?>
                                  </th>
                                

                                 <td>
                                 <a href="verProcesosPlanes.php?identidad=<?php echo $identidad;?>&idContrato=<?php echo $idContrato;?>&empresa=<?php echo $empresa;?>&nomMuni=<?php echo $nomMuni;?>&idEmpleado=<?php echo $idEmpleado;?>">
                      ...
                      <?php 
                              ...
                              <tfoot>
                                    <tr style="background:#1d1a31; color:#FFF;font-size:12px">
                                        <th><center>Cliente</center></th>
                                        <th><center>Descripcioacute;n</center></th>
                                        <th><center>Ver</center></th>
                                    </tr>
                                </tfoot>
                         </table>
