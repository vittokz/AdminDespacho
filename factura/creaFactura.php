                ...
                <tr>
                     <td colspan="2" align="center"><br>
                      ...
                      <td align="center"><center><br><br><br><hr>FACTURA<hr><br>
                          No. VAPS-<?php echo $idLiquida;?> </center>
                      </td>
                </tr>
     </table><br><br><br>
     <table id="mitabla" align="center">        
...
<?php
require_once ('../conexion.php');
$sql=mysql_query("UPDATE des_liquidar_contratos set estadoLiquida='Pagado' where idLiquida like '$idLiquida'");

$carpeta ="pdfFacturas/".$identidad."/";
...
file_put_contents($dir_subida.$idLiquida, $pdf);
