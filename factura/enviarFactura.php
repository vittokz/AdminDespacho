            ...
            <form method="post" action="enviaFacturaElectronicaPHP.php" enctype="multipart/form-data">
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                   <th colspan="2">Pdf Factura
                   <input type="hidden" name="archivo" id="archivo" value="<?php echo 'pdfFacturas/'.$ccCliente.'/'.$idLiquida;?>">
                   </th>
                   <th><a target="_blank" href="pdfFacturas/<?php echo $ccCliente;?>/<?php echo $idLiquida;?>"><img title="Verificar Factura" src="../img/pdf.png" width="10%"></a></a></th>
