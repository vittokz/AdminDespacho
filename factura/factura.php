        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username"><a title="Crear cuenta de cobro" style="text-decoration: none; color:#ffffff" href="cuentadeCobro.php">Crear Cuenta de Cobro</a></h3>
            ...
            <div class="box-footer no-padding">
               <form name="busqueda">
            	 <div class="box-body table-responsive no-padding">
                      ...
                      <tr>
                        <th><select  id="cliente" name="cliente" class="form-control" required>
                       <option value="Seleccione" selected>SELECCIONE</option>
                        <?php
                          $sql=mysql_query("SELECT * FROM des_cliente where estado like 'Activo'  order by empresa ASC ");
                           while($row = mysql_fetch_array($sql)){
                               $identidad=$row['cedula_cliente'];
                               $empresa=$row['empresa'];
                               $contacto=$row['nombre']." ".$row['apellido'];
                       ?>
                             <option value="<?php echo $identidad;?>"><?php echo strtoupper($empresa);?></option>
                           <?php
                           }
                           ?>
                      </select></th>
                       <th> 
                <button title="Buscar planes" style="background-color:#1d1a31" type="submit" onClick="buscarCedula(); return false;" class="btn btn-primary">Buscar</button>
            </th>
                      </tr>
                    </table>  
                </div>
