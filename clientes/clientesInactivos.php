        ...
        <!-- left column -->
          ...
          <br>
           ...
           <div class="box-footer">
                <a title="Clientes Inactivos" href="clientes.php" class="btn btn-primary">Volver a Clientes Activos</a>
              </div>
           <?php
		       $sql=mysql_query("SELECT * FROM des_cliente where estado like 'Inactivo'  order by municipio ");
		   
		   ?>
          <div class="table-responsive">
              <h3>Listado de Clientes-Empresas Inactivos</h3>
