             ...
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th><input type="text" class="form-control" id="identidad" required></th>
                  <th></th>
                  <th></th>
                </tr>
                <tr>
               ...
               <tr>
                ...
                <tr>
                  ...
                  <th><input type="hidden" class="form-control" id="fecha"></th>
                  <th></th>
                  <th></th>
                  <th></th>
                  <th></th>
              ...
              <div class="box-footer">
                <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="enviarDatosCliente(); return false;">Guardar</button>
              </div>
             </div>
            </form>
            <br>
