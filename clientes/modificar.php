<?php require_once("../seguridad/seguridad.php");
     ...
     if(!isset($_SESSION)) { session_start(); } 
       ...
       $sql=mysql_query("SELECT tipo_usuario FROM des_usuario WHERE nombre_usua like '$usuario' and estado_usuario like 'Activo'");
		...
		$sql=mysql_query("SELECT * FROM des_cliente where cedula_cliente like '$identidad'");
        while($row=mysql_fetch_array($sql)) {
            $idCliente=$row['id_cliente'];
            $tipo=$row['tipo'];
            $cc=$row['cedula_cliente'];
            $empresa=$row['empresa'];
            $nombre=$row['nombre'];
             ...
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th><input type="text" class="form-control" id="identidad" required value="<?php echo $cc;?>" disabled></th>
                  <th></th>
                  <th></th>
                </tr>
                <tr>
                  <th>Empresa y/o Entidad</th>
                  <th><input type="text" class="form-control" id="empresa" value="<?php echo $empresa;?>"></th>
                  <th>Nombres</th>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary" onClick="modificarDatosCliente(); return false;">Actualizar</button>
              </div>
             </div>
            </form>
            <br>
