...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <title>.::Subir Documentos Servicios::.</title>
      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
             ...
             <div class="box-body table-responsive no-padding">
              <form method="post" action="registroArchivoServicio.php" enctype="multipart/form-data">
             ...
             <table class="table table-hover">
               <tr>
                  ...
                  <th>Archivo</th>
                  <th><input id="ocultoIdServicio" name="ocultoIdServicio" type="hidden" value="<?php echo $idServicio;?>">
                  <input id="ocultoIdEmpleado" name="ocultoIdEmpleado" type="hidden" value="<?php echo $idEmpleado;?>">
                  <input id="archivo" name="archivo" required type="file" class="form-control"></th>
               </tr>
               <tr>
                  <td>Descripcion</td>
                  <td colspan="3">
