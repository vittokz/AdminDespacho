...
<head>
  ...
  <title>.::Empleados Inactivos viacpro::.</title>
      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
          ...
          <div class="box-footer">
                <a title="Volver a empleados activos" href="empleado.php" style="background-color:#1d1a31" class="btn btn-primary">Volver Empleados Activos</a>
              </div>
          ...
          <br>
           ...
           <div class="box-body">
           <?php
		       $sql=mysql_query("SELECT * FROM des_empleado where estado like 'Inactivo' order by municipio ");
		   
		   ?>
          <div class="table-responsive">
              <h3>Listado de Empleados Inactivos</h3>
