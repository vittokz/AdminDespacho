<?php require_once("../seguridad/seguridad.php");
     ...
     if(!isset($_SESSION)) { session_start(); } 
       ...
       $sql=mysql_query("SELECT tipo_usuario FROM des_usuario WHERE nombre_usua like '$usuario' and estado_usuario like 'Activo'");
		...
		$sqlEmpleado="SELECT * FROM des_empleado WHERE id_empleado like '$idEmpleado' and estado like 'Activo'";
...
<head>
  ...
  <title>.::Procesos asignados::.</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             ...
             <li><a href="../contabilidad/egresosComprobante.php"><i class="fa fa-circle-o"></i>Factura</a></li>
          </ul>
        </li>
        <li>
        ...
        <div class="col-md-12">
         ...
         <div class="table-responsive">
           ...
           while($rowEmpl=mysql_fetch_array($resA)) {
                ...
                $sqlProceso=mysql_query("SELECT * FROM des_procesos WHERE idProceso like '$idProcesoEmpl' and estado like 'Activo' order by fechaProceso DESC");
		   ...
		   ?>
				...
				?>
                  ...
                  <th><a href="../procesos/editarProceso.php?radicado=<?php echo $idRadicado;?>"target="popup"
