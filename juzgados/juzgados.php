      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
            ...
            <form name="juzgados">
             <div class="box-body table-responsive no-padding">
              ...
              <div class="box-footer">
                <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="enviarDatosJuzgado(); return false;">Guardar</button>
              </div>
             </div>
            </form>
            <br>
          ...
          <br>
           ...
           <div class="box-body">
           <?php
		       $sql=mysql_query("SELECT * FROM des_juzgados where estado like 'Activo' order by ciudad ");
          ...
          <div class="table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				?>
                  ...
                  <th><a href="../procesos/procesosJuzgadoRegistro.php?idJuzgado=<?php echo $idJuzgado;?>"><img  src='../img/ver.png' width='28' height='22' title="Ver procesos">VER</a></th>
                  <?php
				  if($tipoUsuario==1){
				  ?>
                  <th><a href="actualizar.php?idJuzgado=<?php echo $idJuzgado;?>" target="popup"
onClick="window.open(this.href, this.target, 'toolbar=0 , location=1 , status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=250pt,top=50pt,width=950px,height=500px'); return false;">
                  <img  src='../img/actualizar.png' width='25' height='27' title="Modificar Juzgado"></a></th>
                  <th><a href="eliminar.php?idJuzgado=<?php echo $idJuzgado;?>">
                  <img  src='../img/borrar.png' width='28' height='25' title="Eliminar Juzgado"></a></th>
                <?php
				  }
				  else{
				?>
                  <th><img  src='../img/actualizar.png' width='25' height='27' title="Modificar Juzgado"></th>
                  <th><img  src='../img/borrar.png' width='28' height='25' title="Eliminar Juzgado"></th>
                <?php
				  }
				  ?>
