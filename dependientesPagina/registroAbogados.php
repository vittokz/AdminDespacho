          ...
          <div class="box box-primary">
             <form name="registrar" method="post">
              ...
              <div class="box-footer">
                <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="enviarDatosRegistro(); return false;">Editar</button>
              </div>
            </form>
            </div>
           </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				?>
                  <tr style="font-size:11px">
                      ...
                      <th><a href="modificarEmpresaAbo.php?id=<?php echo $id;?>&cliente=<?php echo $cliente;?>&email=<?php echo $email;?>&telefono=<?php echo $telefono;?>&ciudad=<?php echo $ciudad;?>" target="popup"
