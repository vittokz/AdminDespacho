...
<head>
  ...
  <title>.::Dependientes Pagina viacpro::.</title>
      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
          ...
          <br>
           ...
           <div class="box-body">
           <?php
		       $sql=mysql_query("SELECT * FROM des_trabaje where tipo like 'Dependiente' order by ciudad DESC ");
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				?>
                  <tr style="font-size:11px">
                      ...
                      <th><?php echo strtoupper($tipoT);?></th>
                      <th><?php echo strtoupper($fechaRegistro);?></th>
                      <th><a href="eliminar.php?id=<?php echo $idTrabaje;?>">Eliminar</a></th>
