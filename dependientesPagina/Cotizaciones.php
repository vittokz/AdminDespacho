...
<head>
  ...
  <title>.::Cotizaciones Pagina viacpro::.</title>
      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
          ...
          <br>
           ...
           <div class="box-body">
           <?php
		       $sql=mysql_query("SELECT * FROM des_cotizacion where nomEmpresa <> '' order by fechaRegistro ASC");
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
				 while($row = mysql_fetch_array($sql)){
                  ...
                  $detalleMuni=$row['detalleMuni'];
                  $fechaRegistro=$row['fechaRegistro'];
                  
				?>
                  <tr style="font-size:11px">
                      <th><?php echo strtoupper($nomEmpresa);?></th>
                      <th><?php echo strtolower($email);?></th>
                      <th><?php echo $telefono;?></th>
                      <th><?php echo strtoupper($detalleMuni);?></th>
                      <th><?php echo strtoupper($fechaRegistro);?></th>
                      <th>
                         <?php
                          if($estado==""){
                         ?>
                           <a style="background-color:RED; color:#ffffff" title="Cambiar estado" class="btn btn-success"
                 href="cambiarEstado.php?idCot=<?php echo $idCot;?>" target="popup" onClick="window.open(this.href, this.target, 'toolbar=0 , location=1,status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=350pt,top=70pt,width=750px,height=420px'); return false;" >
                Pendiente</a>
                         <?php
                          }  
                          if($estado=="Enviada"){
                          ?>
                          <a style="background-color:GREEN; color:#ffffff" title="Cambiar estado" class="btn btn-success"
                 href="cambiarEstado.php?idTarea=<?php echo $idCot;?>" target="popup" onClick="window.open(this.href, this.target, 'toolbar=0 , location=1,status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=350pt,top=70pt,width=750px,height=420px'); return false;" >
                Enviada</a>
