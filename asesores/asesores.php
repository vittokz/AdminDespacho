...
$sql=mysql_query("SELECT * FROM des_tareas where fecha between '$hoy' and '$nuevafecha'");
    while($row=mysql_fetch_array($sql)) 
     {
            ...
            <div class="box-footer">
              <div class="row">
                <div class="col-sm-12 border-right">
                  ...
                  <form name="buscarLLamada">
                          <table class="table table-hover">
                                <tr>
                                  <th>Cliente/Empresa</th>
                                  <th> 
                                  <input type="text" class="form-control" id="clienteL" required autofocus>
                                  </th>
                                 
                                  <th>
                                  <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="buscarLlamada(); return false;">Buscar</button>
                                
                                  </th>
                                </tr>
                          </table>
                  </form>
                  <div id="resultadoLlamadas">

                   </div>
                  <div width="100%" style="background-color:#1d1a31; color:#1d1a31">a</div>
                  <form name="llamadas">
                          <table class="table table-hover">
                                <tr>
                                  <th>Cliente/Empresa</th>
                                ...
                                <tr>
                                  <th>Celular  </th>
                                  <th> <input type="number" class="form-control" id="celular" required>
                                  <th>Contacto  </th>
                                  <th> <input type="text" class="form-control" id="contacto" required><br>
                                  </th>
                                 </tr>
                                 <tr>
                                  
                                  <th>Fecha  </th>
                                  <th> <input type="date" class="form-control" id="fecha" required><br>
                                  </th>
                                  <th> </th>
                                  <th>
                                  </th>
                               ...
                               <tr>
                                 <th colpans="4">
                                    ...
                                    <button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="registrarLlamada(); return false;">Registrar</button>
