      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form name="noticias" method="post" action="subir.php" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="descripcion" placeholder="Describa noticia" cols="40" rows="5"></textarea>
                </div>
