<?php require_once("../seguridad/seguridad.php");
     ...
     if(!isset($_SESSION)) { session_start(); } 
       ...
       $idPlan="";
       $sql=mysql_query("SELECT * FROM des_contratos_empresas where identidad like '$identidad'");
       $resulEmpresa=mysql_query($sql);
      ...
      //fin  plan
       $banP=0;
       $sql="SELECT * FROM des_procesos where idCliente like '$identidad' and idPlan like '$idPlan'";
         ...
         <div class="box-body table-responsive no-padding">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><div style="background-color:RED; color:white">Crear Proceso Planes Nuevos</div></h3>
            </div>
            <form name="procesos">
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
             ...
             ?>
               ...
               ?>
                <div align="center" class="box-footer" style="background-color:#9E2309;color:WHITE;font-weight:bold">
                     Ya registro sus <?php $maximo;?> procesos debe cambiar de plan si desea agregar mas procesos!!!
                </div> 
               <?php
               }
               ?> 
          ...
          if($resulEmpresa<=0){
            ...
            $sqlProceso="";
			  	...
			  	$sqlProceso=mysql_query("SELECT * FROM des_procesos WHERE idCliente like '$identidad' and estado <> 'Eliminado' order by fechaProceso DESC");
          }
		   ?>
      ...
      ?>
              ...
              <tr style="font-size:11px; background:<?php echo $color;?>">
                  ...
                  <th>
                      ...
                      ?>
                  <a href="editarProcesoNuevo.php?idProceso=<?php echo $idProceso;?>"target="popup"
