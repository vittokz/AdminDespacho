<?php require_once("../seguridad/seguridad.php");
     ...
     if(!isset($_SESSION)) { session_start(); } 
       ...
       $sql=mysql_query("SELECT tipo_usuario FROM des_usuario WHERE nombre_usua like '$usuario' and estado_usuario like 'Activo'");
		...
		$nombre="";$apellido ="";$tel ="";$cel ="";$email ="";$ban=0;
		...
		if($ban==0){
			echo "<CENTER><p style='font-size:18px; color:RED'>Número de Identidad no existe!!!</p></CENTER>";
		}
		else{
   ...
   <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td style="font-size:16px"><a href="procesosRegistro.php?identidad=<?php echo $identidad;?>">
