...
<head>
  ...
  <title>.::Subir Fijación en Lista::.</title>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1> Procesos\Fijación en Lista </h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
             <p style="font-size:18px">Información Fijación en Lista</p> 
            </div>
          
             <div class="box-body table-responsive no-padding">
            <form name="fijacion" method="post" action="registroFijacion.php" enctype="multipart/form-data" > 
            <div class="box-body table-responsive no-padding">
             <table class="table table-hover">
               <tr>
                  <th>N° Fijación en Lista</th>
                  <th><input name="email" id="email" type="hidden" value="<?php echo $email;?>">
                  <input name="numFijacion" id="numFijacion" type="number" class="form-control" required autofocus></th>
                  <th>Fecha Auto</th>
               ...
               <tr>
                  <th>Asunto</th>
                  <th>
                  <textarea name="asunto" id="asunto" cols="10" rows="4"  class="form-control"></textarea></th>
               ...
               <tr>
                  <th>Fecha Inicio</th>
                  <th><input name="fechaInicio" id="fechaInicio" type="date" class="form-control" required></th>  
                  <th>Fecha Fin</th>
