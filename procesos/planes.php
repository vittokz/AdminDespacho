      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
         ...
         <div class="table-responsive">
             <h2>Listado de Planes del CLiente</h2>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $idPlan="";
                $sql=mysql_query("SELECT * FROM des_contratos_empresas where identidad like '$identidad' and estado like 'Activo'");
              ...
              <tr style="font-size:11px; background:<?php echo $color;?>">
                  ...
                  <td><a href="modificaEstadoPlan.php?id=<?php echo $id;?>&identidad=<?php echo $identidad;?>">Inactivar</a></td>                
                  <td><?php echo "$ ".number_format($valor);?></td>
                  <td><a href="planSeleccionado.php?idPlan=<?php echo $idPlan;?>&descripcion=<?php echo $descripcion;?>&identidad=<?php echo $identidad;?>&idContrato=<?php echo $id;?>">
