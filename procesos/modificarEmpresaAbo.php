        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
             ...
             <div class="box-body table-responsive no-padding">
            <form name="actuaciones" method="post" action="registroActuacion.php" enctype="multipart/form-data"> 
            <div class="box-body table-responsive no-padding">
             <table class="table table-hover">
               <tr>
                  <th>N° de Estado</th>
               ...
               <tr>
                  ...
                  <th><input id="archivo[]" name="archivo[]" type="file" class="form-control" multiple="" required></th>
