   ...
   require_once ('../conexion.php');
	 if(!isset($_SESSION)) { session_start(); } 
	  ...
	  $nomJuzgado="";
				...
				//registro el proceso
				$sql="INSERT INTO des_procesos (idRadicado,idCliente,tiempo,valor,iva,total,idJuzgado,idTipoProceso,demandado,demandante,asignado,idPlan,idContrato,fechaRegistro,usuarioRegistra,fechaProceso,fechaTerminacion,estado)VALUES ('$radicado','$identidad','NO','NO','NO','NO','$idJuzgado','$tipo','$demandado','$demandante','$empleado','$idPlan','$idContrato','$hoy','$usuario','$fechaProceso','NO','Activo')";
