      ...
      <section class="content-header" style="width:100%">
        ...
        <div class="col-md-12">
             ...
             <div class="box-body table-responsive no-padding">
              ...
              <tr>
               ...
               <tr>
                ...
                <tr>
                  <th>Valor</th>
                  <th> <input type="number" class="form-control" id="valor" size="40" value="<?php echo $total;?>"></th>
                  <th>Valor Iva</th>
                  <th> <input type="number" disabled class="form-control" id="valorIva" size="40" value="<?php echo $iva;?>"></th>
            ...
            if($estadoProceso=="Cerrado")
             {
			   ...
			   ?>
                ...
                <button title="Renovar proceso" class="btn btn-success">
                <a style="text-decoration: none; color:WHITE" href="renovarProceso.php?idRadicado=<?php echo $idRadicado;?>&identidad=<?php echo $identidad;?>" target="popup" onClick="window.open(this.href, this.target, 'toolbar=0 , location=1,status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=290pt,top=70pt,width=750px,height=520px'); return false;" >
                Renovar Proceso</a></button>

                <button title="Asignar Dependiente" class="btn btn-primary">
                <a style="text-decoration: none; color:WHITE" href="asignarDependiente.php?idProceso=<?php echo $idProceso;?>&idRadicado=<?php echo $idRadicado;?>&identidad=<?php echo $identidad;?>" target="popup" onClick="window.open(this.href, this.target, 'toolbar=0 , location=1,status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=350pt,top=70pt,width=750px,height=380px'); return false;" >
                Asignar dependiente</a></button>
                
                <button title="Asignar Dependiente" class="btn btn-danger">
          ...
          <br>
           ...
           <div class="box-body">
           <?php
		       $sqlD="SELECT idAsignacion,idEmpleado FROM des_asignacion_procesos where idProceso like '$idProceso' and estado like 'Activo' order by fechaRegistro DESC";
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                   while($rowD = mysql_fetch_array($resulD)){
                      ...
                      $idAsignacion=$rowD['idAsignacion'];
                  ...
                  ?>
                         <tr style="font-size:12px">
                          ...
                          <th>
                          <a style="text-decoration:none" href="eliminarDependiente.php?idAsignacion=<?php echo $idAsignacion;?>&identidad=<?php echo $identidad;?>&idProceso=<?php echo $idProceso;?>">
                   <img  src='../img/borrar.png' width='28' height='25' title="Eliminar Dependiente">
                  </a></th>
                        </tr>
                    <?php
                           }
