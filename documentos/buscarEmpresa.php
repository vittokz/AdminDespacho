   ...
   <div class="box-body table-responsive no-padding">
             ...
             ?>
                <tr>
                  ...
                  <td style="font-size:16px"><center><a href="contratos.php?iden=<?php echo $cedula;?>">
                  <img  src='../img/ver.png' width='35' height='22' title="Crear Contrato">Ir</a></center></td>
                  <td style="font-size:16px"><center><a href="subirContrato.php?iden=<?php echo $cedula;?>">
                  <img  src='../img/ver.png' width='35' height='22' title="Subir Contrato">Ir</a></center></td>
                </tr>
             <?php
              }
