...
<head>
  ...
  <title>.::Crear contrato empresa::.</title>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        ...
        <img  src='../img/atras.png' width='38' height='35' title="Volver a lista de procesos"></a>Generar Contrato </h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
             ...
             <form action="registro.php" enctype="multipart/form-data" method="post">
              <table class="table table-hover">
                <tr>
                  <th>Contratante</th>
                  <th style="color:#069">                
                     <input name="contratante" type="text" class="form-control" required autofocus>  
                  </th>
                  <th>Fecha de Firma</th>
                  <th style="color:#069"><input name="fecha" type="date" class="form-control" required></th>
                   <th><input class="btn btn-primary" type="submit" value="Cargar" title="Cargar archivo al sistema" ></th>
               </tr>
