  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Subir Documentos y Generar Contrato</h1><br>
          <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-yellow">
              ...
              <!-- /.widget-user-image -->
              <h3 class="widget-user-username">Realizar Busqueda</h3>
               ...
               <form name="busqueda">
            	 <div class="box-body table-responsive no-padding">
                      ...
                      <tr>
                        ...
                        <th><button type="submit" style="background-color:#1d1a31" class="btn btn-primary" onClick="buscarCedula(); return false;">Buscar</button></th>
