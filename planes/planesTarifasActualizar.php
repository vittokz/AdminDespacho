...
<head>
  ...
  <title>.::Modificar Tarifas Clientes::.</title>
 ...
 <header class="main-header">
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      <h1>Modificar Tarifa Año <?php echo $ano;?></h1><br>
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form name="tarifas" action="modificarTarifas.php" method="post">
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
               <?php
                $sql=mysql_query("SELECT * FROM des_planes where ano like '$ano' and estado like 'Activo' order by idPlan ASC");
                while($row = mysql_fetch_array($sql)){
                     ...
                     $asesorComercial=$row['asesorComercial'];
              ...
              ?>
               <tr><th style="background-color:#022237; color:#FFFFFF" colspan="10"><?php echo $nombrePlan." (".$min." a ".$max." procesos)"; ?></th></tr>
                <tr>
                  <th>Valor</th>
                  <th> <input type="hidden" name="ano" value="<?php echo $ano;?>">
                  <input type="hidden" name="tipoEstado[]" value="<?php echo $tipoEstado;?>">
                  <input type="hidden" name="idTarifa[]" value="<?php echo $idPlan;?>">
                  <input placeholder="Valor" type="number" class="form-control" name="plan1[]" required value="<?php echo $valor;?>"></th>
                  <th>Asesor Comercial</th>
                  <th><input placeholder="Valor" type="number" class="form-control" name="ase1[]" required value="<?php echo $asesorComercial;?>"></th>
                  <th>Ger. Comercial</th>
                  <th><input placeholder="Valor" type="number" class="form-control" name="gerC1[]" required value="<?php echo $gerenteComercial;?>"></th>
                  <th>Ger. General</th>
                  <th><input placeholder="Valor" type="number" class="form-control" name="gerG1[]" required value="<?php echo $gerenteGeneral;?>"></th>
                  <th>Dependiente</th>
                  <th><input placeholder="Valor" type="number" class="form-control" name="dep1[]" required value="<?php echo $dependiente;?>"></th>
                </tr>
               <?php
                }   
                ?> 
              ...
              <div class="box-footer">
                <button title="Actualizar valores" type="submit" style="background-color:#1d1a31" class="btn btn-primary">Actualizar</button>
              </div>
             </div>
            </form>
            <br>
