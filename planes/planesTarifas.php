      ...
      <section class="content-header" style="width:100%">
        ...
        <!-- left column -->
          ...
          <br>
           <div class="box">
           <div class="box-body">
           <a title="Registrar Tarifas" style="background-color:#1d1a31" href="formTarifas.php" class="btn btn-primary">Registrar Tarifas</a>
           
          
           <?php
		       $sql=mysql_query("SELECT distinct(ano),estado,tipoEstado FROM des_planes order by idPlan");
		   
		   ?>
          <div class="table-responsive">
              <h3>Tarifas VIACPRO</h3>
          ...
          <tr style="align=center;background-color:<?php echo $color;?>;font-size:11px">
                  ...
                  <th><?php echo $tipoEstado;?></th>
                  <th><a href="planesTarifasDetallado.php?ano=<?php echo $ano;?>">Ver</a></th>
                  <th><a href="planesTarifasActualizar.php?ano=<?php echo $ano;?>">Actualizar</a></th>
