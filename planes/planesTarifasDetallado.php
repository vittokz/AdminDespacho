...
<head>
  ...
  <title>.::Tarifas Clientes Detalle::.</title>
      ...
      <section class="content-header" style="width:100%">
        ...
        <!-- left column -->
          ...
          <br>
           ...
           <?php
		       $sql=mysql_query("SELECT * FROM des_planes where ano like '$ano' order by idPlan");
		   
		   ?>
          <div class="table-responsive">
              <h3>Tarifas VIACPRO <?php echo $ano;?></h3>
                ...
                <?php
				 while($row = mysql_fetch_array($sql)){
                  ...
                  if($estado=="Inactivo")
                        $color="#FFB4A4";     
				?>
          <tr style="align=center;background-color:<?php echo $color;?>;font-size:11px">
                  <th><?php echo $nombrePlan;?></th>
                  <th><?php echo $descripcion;?></th>
                  <th><?php echo "$ ".number_format($valor);?></th>
                  <th><?php echo "$ ".number_format($asesorComercial);?></th>
                  <th><?php echo "$ ".number_format($dependiente);?></th>
                  <th><?php echo "$ ".number_format($gerenteComercial);?></th>
                  <th><?php echo "$ ".number_format($gerenteGeneral);?></th>
          <?php
         }
          ?>
                </tbody>
