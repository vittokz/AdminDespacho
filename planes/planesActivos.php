        ...
        <div class="col-md-12">
         ...
         <div class="table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $idPlan="";
                $sql=mysql_query("SELECT * FROM des_contratos_empresas where estado like 'Activo'");
                ...
                while($row=mysql_fetch_array($sql)) {
                          ...
                          $sqlCliente=mysql_query("SELECT * FROM des_cliente WHERE cedula_cliente like '$identidadCliente' and estado like 'Activo'");
              ...
              <tr style="font-size:11px; background:<?php echo $color;?>">
                  ...
                  <td><a href="../procesos/modificaEstadoPlan.php?id=<?php echo $id;?>&identidad=<?php echo $identidadCliente;?>">Inactivar</a></td>                
