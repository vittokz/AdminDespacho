              ...
              <div class="col-md-4">
                ...
                <div class="box box-widget widget-user-2">
                  ...
                  <div class="box-footer no-padding">
                    ...
                    $sql="SELECT id_usuario,nombre_usua FROM des_usuario where estado_usuario like 'Activo' and nombre_usua <> '$usuario' order by nombre_usua ASC";
                      $resul = mysql_query($sql);
                      while($row=mysql_fetch_array($resul)) {
                        $nombreUsuario=$row["nombre_usua"];
                          $idUsuario=$row["id_usuario"];
                            
                          $sqlM="SELECT * FROM des_mensajes 
                          where usuarioRecibe like '$usuario' and usuarioRemite like '$nombreUsuario' and estado like 'No Leido'";
                          $resulM = mysql_query($sqlM);
                          $conMensajeM=0;		
                          while($rowM=mysql_fetch_array($resulM)) {
                            $conMensajeM ++;
                          }
                          mysql_free_result($resulM);
                      
                    ?>
                                <tr style="background:#F4F4F4">
                                  <th><img  src='../img/usuario.png' width='22' height='25'><?php echo $nombreUsuario;?></th>
                                  <th style="color:#900; font-weight:700"><?php echo $conMensajeM;?></th>
                                  <th>
                                  <a target="_blank" href="verMensaje.php?nomUsuario=<?php echo $nombreUsuario;?>" target="popup"
      onClick="window.open(this.href, this.target, 'toolbar=0 , location=1 , status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=330pt,top=50pt,width=700px,height=680px'); return false;">
                        <img  src='../img/mensaje.png' width='28' height='25' title="Ver mensajes"></a></th>
                            </tr> 
                            <?php
                      }
                  ?>
      ...
      <div class="col-md-8">
                ...
                <div class="box box-widget widget-user-2">
                  ...
                  <div class="box-footer no-padding">
                    ...
                    <div class="box-body table-responsive no-padding">
                       <a href="../pages/mailbox/mailbox.php"><img src="../img/envioMail.png" width="31%"></a>CORREO INTERNO
                    </div>
