		   ...
		   ?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="font-size:11px">
                  ...
                  <th align="right"><a href="../../procesos/img/actuaciones<?php echo $idActuacion;?>/<?php echo $nombre;?>" target="popup"
onClick="window.open(this.href, this.target, 'toolbar=0 , location=1 , status=0 , menubar=1 , scrollbars=0 , resizable=1 ,left=330pt,top=50pt,width=700px,height=550px'); return false;">
                 <img  src='../img/ver.png' width='32' height='26' title="Ver archivo"></a>
                  ...
                  <th><a style="text-decoration:none" href="eliminarFoto.php?idFoto=<?php echo $idFoto;?>&idProceso=<?php echo $idProceso;?>&idActuacion=<?php echo $idActuacion;?>">
