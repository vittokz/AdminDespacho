<?php require_once("../seguridad/seguridad.php");
  ...
  $numEstado=0;
  $sqlA=mysql_query("SELECT max(numGasto) as mayor FROM des_gastosycompras");
...
<head>
  ...
  <title>.::Compras y gastos viacpro::.</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
             <li class="active"><a href="../contabilidad/comprasygastos.php"><i class="fa fa-circle-o"></i>Compras/Gastos</a></li>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Contabilidad-Compras y Gastos </h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <form name="compras">
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  <th>N° de Gasto/Compra</th>
                  <th><input type="number" class="form-control" id="numGasto" value="<?php echo $numEstado;?>" disabled></th>
                  <th>Descripción</th>
              ...
              <div class="box-footer">
                <button title="Registrar gasto" type="submit" class="btn btn-primary" onClick="enviarDatosGasto(); return false;">Registrar</button>
              </div>
             </div>
            </form>
            <br>
          ...
          <br>
           ...
           <div class="box-body">
           <?php
		       $sql=mysql_query("SELECT * FROM des_gastosycompras order by fecha DESC ");
          ...
          <div class="table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
				 while($row = mysql_fetch_array($sql)){
           $numGasto=$row['numGasto'];
           $descripcion=$row['descripcion'];
           $valor=$row['valor'];
           $fecha=$row['fecha'];
				?>
                  <tr style="font-size:11px">
                  <th><?php echo $numGasto;?></th>
