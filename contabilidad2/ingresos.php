<?php require_once("../seguridad/seguridad.php");
  ...
  $numEstado=0;
  $sqlA=mysql_query("SELECT max(numGasto) as mayor FROM des_ingresosyegresos");
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header" style="width:100%">
        <h1>Contabilidad-  Ingresos </h1><br>
        <div class="row">
        <!-- left column -->
        <div class="col-md-12">
             ...
             <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th>Identidad</th>
                  <th><input autofocus onChange="buscarCedula(); return false;" type="text" class="form-control" id="identidad" placeholder="Nit empresa">
                ...
                <tr>
                  <th colspan="4">
                  <div style="background-color:#337DFF; font-size:16px; font-family:Verdana, Geneva, sans-serif; color:#FFF" id="mostrarNombre">
                ...
                <tr>
                  <th>Descripción</th>
                  <th><input type="text" class="form-control" id="descripcion" required></th>
                  <th>Valor</th>
                  <th><input type="number" class="form-control" id="valor"></th>
                </tr>
                <tr>
                   <th colspan="4">PERIODO A CANCELAR</th>
                </tr>
                <tr>
                  <th>Fecha Inicial</th>
                  <th><input type="date" class="form-control" id="fechaInicial" required></th>
                  <th>Fecha Final</th>
                  <th><input type="date" class="form-control" id="fechaFinal" required></th>
                 
                  
               </tr>
            </table>   
              <div class="box-footer">
                <button title="Registrar Ingreso" type="submit" class="btn btn-primary" onClick="enviarDatosIngreso(); return false;">Registrar</button>
              </div>
             </div>
            </form>
            <br>
          ...
          <br>
           ...
           <div class="box-body">
           <?php
		       $sql=mysql_query("SELECT * FROM des_ingresosyegresos order by fechaInicial DESC ");
          ...
          <div class="table-responsive">
           ...
           $fecha=$row['fecha'];
				?>
                  ...
                  <th><?php echo $identidad;?></th>
                  <th><?php echo strtoupper($descripcion);?></th>
                  <th><?php echo "$".number_format($valor);?></th>
                  <th><a target="_blank" href="generaReciboEmpresa.php?numComprobante=<?php echo $numComprobante;?>">Imprimir</a></th>
